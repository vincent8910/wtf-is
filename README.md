...
| [🤖 AI / 機器學習](ai-ml/README.md) | 50 | LLM、GPT、Transformer、Prompt Engineering⋯⋯ |
...
> 共收錄 **168 個**術語，[點此進入完整頁面](software-engineering/README.md)。
...
> 共收錄 **30 個**術語，[點此進入完整頁面](electronics/README.md)。
...
> 共收錄 **50 個**術語，[點此進入完整頁面](ai-ml/README.md)。
